...
class DetailsActivity : AppCompatActivity(),
    ...
    override fun setResult(detailsModel: DetailsModel) {
        ...
        mVoteCount.setText(getString(R.string.voteCount) + detailsModel.voteCount.toString())
        mRelasedData.setText(getString(R.string.releaseDate) + detailsModel.releaseDate)
        mOriginalLang.setText(getString(R.string.originalLanguage) + detailsModel.originalLanguage)
